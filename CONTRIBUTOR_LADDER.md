# Agentgateway Contributor Ladder
...
* Responsibilities include:
    * Following the [agentgateway Code of Conduct](CODE_OF_CONDUCT.md)
    * Following the project [contributing guide](CONTRIBUTION.md)
...
A Reviewer must meet the responsibilities and requirements of a Contributor, plus:

* Responsibilities include:
    * Continues to contribute regularly, as demonstrated by having at least 3 agentgateway GitHub contributions per year.
* Requirements:
    * Must have successful contributions to the project, including at least one merged PR.
    * Must be a member of the [agentgateway Discord](https://discord.gg/BdJpzaPjHv).
    ...
    * Must attend an agentgateway community meeting at least once to meet with other members/maintainers. Frequent attendance is encouraged. (If the meeting time is too inconvenient, please reach out via Discord and we can work something out.)
* Privileges:
    * May be assigned Issues and Reviews.
    * May give commands to CI/CD automation.
    * May label/triage issues.

To apply to become a Reviewer in the agentgateway organization on GitHub, please open a GitHub PR in the community repository using the [reviewer request template](.github/PULL_REQUEST_TEMPLATE/apply_to_be_a_reviewer.md).
...
Involuntary removal/demotion of a contributor happens when responsibilities and requirements aren't being met. This may include repeated patterns of inactivity, an extended period of inactivity, a period of failing to meet the requirements of your role, abusing the CI/CD privileges and/or a violation of the Code of Conduct. This process is important because it protects the community and its deliverables while also opening up opportunities for new contributors to step in.
...
Contact the maintainers in the [agentgateway Discord](https://discord.gg/BdJpzaPjHv) about changing to Emeritus status, or reducing your contributor level.
